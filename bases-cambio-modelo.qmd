...
- **[Presentación del taller](100-oc-divulga.qmd)** — Material visual con ejemplos y ejercicios guiados de la sesión práctica.
...
Para más detalles, consulta la [presentación del taller](100-oc-divulga.qmd) o mira el [vídeo de la sesión](https://umurcia.zoom.us/rec/play/ta3zzdOjkFywo35Vv7wnFcdCrcN9RDUWLQMlHe7XisW5Rnngz-crhdENH_zNkkzCWIkwoxmZPVppYldd.RBA5dxmy19eX7_wq?accessLevel=meeting&canPlayFromShare=true&from=share_recording_detail&continueMode=true&oldStyle=true&componentName=rec-play&originRequestUrl=https%3A%2F%2Fumurcia.zoom.us%2Frec%2Fshare%2FYKZsu4UUeSnneT9xbQyFCPgkImjaFQqMxLQRyeQXsDsFGurxpD9E7fZjkoxVkavK.1wf4sZyQa88k4NH0){target="_blank"}.
...
- **[Presentación del taller](100-oc-divulga.qmd)** — Material visual con ejemplos y ejercicios guiados.
...
- **[Anexo: Ejemplo de uso ineficiente de un procesador de textos](analisis-plantilla-ineficiente.qmd)** — Caso real de dos plantillas que reproducen todas las ineficiencias descritas.

- **[Anexo: Características compartidas en el uso del procesador de textos](analisis-plantillas-universitarias.qmd)** — Análisis comparativo de diez documentos universitarios con datos cuantitativos y patrones transversales.
